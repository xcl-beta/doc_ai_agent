            ...
            messages=[
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": "Extract the text from this image, ensuring all text and numbers are captured accurately." + \
                                    "If the info looks from a table, add markdown tags for tabular format." + \
